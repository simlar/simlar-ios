...
typedef NS_ENUM(NSUInteger, SMLRNetworkQuality) {
    SMLRNetworkQualityUnknown = 0,
    SMLRNetworkQualityUnusable,
    SMLRNetworkQualityVeryPoor,
    SMLRNetworkQualityPoor,
    SMLRNetworkQualityAverage,
    SMLRNetworkQualityGood
};
