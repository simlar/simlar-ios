...
### ATTENTION: this assumes the version is the 4th property
/usr/libexec/PlistBuddy -c "Set :PreferenceSpecifiers:3:DefaultValue ${GIT_RELEASE_VERSION}" "${BUILT_PRODUCTS_DIR}/Simlar.app/Settings.bundle/Root.plist"
