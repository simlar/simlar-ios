...
public class Core : LinphoneObject
{
	...
	/// 
	/// - See also: {@link Core#enableForcedIceRelay}. 
	...
	/// 
	/// - Parameter id: the tone id 
	/// - Parameter audiofile: a wav file to be played. 
	/// 
	public func setTone(id:ToneID, audiofile:String) 
	{
		linphone_core_set_tone(cPtr, LinphoneToneID(rawValue: CUnsignedInt(id.rawValue)), audiofile)
	}
...
public class PayloadType : LinphoneObject
{
	...
	/// - Returns: The newly created `PayloadType` object. @notnil 
